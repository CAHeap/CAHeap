...
HD_PWD='F:/work files/AHeap-vivado/AHeap/AHeap.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AHeap_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AHeap_top.tcl
