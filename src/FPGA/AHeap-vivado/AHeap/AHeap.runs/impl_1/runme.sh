...
HD_PWD='F:/work files/AHeap-vivado/AHeap/AHeap.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AHeap_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AHeap_top.tcl -notrace
